...
class ImportAccountSetDialog(QDialog):
    ...
    def _build_step2(self):
        ...
        vchr_hdr.addStretch()
        b_vchr_add = QPushButton("＋ 添加文件"); b_vchr_add.setObjectName("btn_outline"); b_vchr_add.setFixedWidth(101)
        b_vchr_clr = QPushButton("清空");        b_vchr_clr.setObjectName("btn_gray");    b_vchr_clr.setFixedWidth(60)
        ...
        for key, label, desc in single_types:
            ...
            b_clr = QPushButton("✕");   b_clr.setObjectName("btn_gray");    b_clr.setFixedSize(40,26)
